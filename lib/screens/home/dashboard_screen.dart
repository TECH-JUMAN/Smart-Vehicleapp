...
class _DashboardHome extends StatelessWidget {
  ...
  Color _getAirQualityColor(String airQuality) {
    ...
    if (airQuality == 'Warning' || airQuality == 'Low')
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          if (authProvider.currentUser != null) {
            await vehicleProvider.loadVehicleByOwner(
          ...
          child: Consumer<VehicleProvider>(
            builder: (context, vehicleProvider, _) {
              ...
              if (sensorData?.batteryVoltage != null) {
                ...
                batteryPercentage = ((voltage - 11.5) / (12.6 - 11.5) * 100)
                    .clamp(0.0, 100.0);
              }

              // Air quality derived from vehicle status and fuel level
              final airQuality = _getAirQualityStatus(status);
              ...
              return Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      final lat =
                          sensorData?.latitude ?? AppConstants.defaultLatitude;
                      final lng =
  ...
  Widget _buildVehicleStatusChart(BuildContext context, sensorData, vehicle) {
    final databaseService = DatabaseService();
      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: _buildStatusCard(
                  ...
                  sensorData.batteryVoltage != null
                      ...
                      : 'Not available',
                  sensorData.batteryVoltage != null &&
                          ((sensorData.batteryVoltage! - 11.5) /
                                  (12.6 - 11.5) *
                                  100) <
                              20
                      ? AppTheme.warningColor
            ...
            builder: (context, snapshot) {
              ...
              for (int i = 0; i < historyData.length; i++) {
                ...
                if (data.batteryVoltage != null) {
                  final percentage =
                      ((data.batteryVoltage! - 11.5) / (12.6 - 11.5) * 100)
                          .clamp(0.0, 100.0);
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              _buildLegendItem(context, AppTheme.primaryColor, 'Battery (%)'),
              const SizedBox(width: 20),
              _buildLegendItem(context, AppTheme.warningColor, 'Location'),
            ],
          ),
        ],
      ),
