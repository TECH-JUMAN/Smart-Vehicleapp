...
class MaintenanceListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (vehicleProvider.currentVehicle == null) {
      return Scaffold(
        ...
        body: const Center(child: Text('No vehicle registered')),
      );
    }
  ...
  void _showDeleteDialog(BuildContext context, MaintenanceModel maintenance) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Confirm Delete'),
        content: Text(
          'Are you sure you want to delete the maintenance record "${maintenance.type}"?',
        ),
        actions: [
          TextButton(
